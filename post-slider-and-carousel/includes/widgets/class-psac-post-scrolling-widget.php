  ...
  function form($instance) {
	...
	*/
	function widget($args, $instance) {
		...
		$post_args = apply_filters( 'psacp_post_scrolling_widget_query_args', $post_args, $instance );
	...
	<div class="psac-widget-wrp psac-recent-post-items">
		<div class="psac-vticker-scrolling-wdgt" id="psac-post-ticker-<?php echo esc_attr( $unique ); ?>" data-conf="<?php echo htmlspecialchars(json_encode($slider_conf)); ?>">
			<ul>
